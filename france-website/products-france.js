...
const sampleData = [
  {
    id: 'tgv-01',
    title: 'TGV & High-speed Rail (Alstom)',
    category: 'mobility',
    tags: ['tgv','alstom','rail'],
    image: 'https://images.unsplash.com/photo-1516822003754-cca485356ecb?q=80&w=800&auto=format&fit=crop',
    short: 'France’s iconic high-speed rail and signalling innovations.',
    long: 'TGV technology, signalling systems, and station automation — advancements by Alstom and partners that shaped high-speed rail worldwide.'
  },
  {
    id: 'airbus-01',
    title: 'Avionics & Aerospace Systems (Airbus)',
    category: 'ai',
    tags: ['avionics','aerospace','airbus'],
    image: 'https://images.unsplash.com/photo-1526772662000-3f88f10405ff?q=80&w=800&auto=format&fit=crop',
    short: 'Commercial aircraft systems and on-board AI from Airbus.',
    long: 'Flight-control systems, predictive maintenance, and collaborative avionics integrating edge AI for safer, more efficient air travel.'
  },
  {
    id: 'parrot-01',
    title: 'Civilian Drones & Imaging (Parrot)',
    category: 'robotics',
    tags: ['drones','imaging','survey'],
    image: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?q=80&w=800&auto=format&fit=crop',
    short: 'Compact drones for mapping, inspection and agriculture.',
    long: 'Lightweight UAVs with advanced imaging and autonomy for surveying, precision agriculture, and industrial inspections.'
  },
  {
    id: 'edf-01',
    title: 'Smart Grid & Renewable Integration (EDF)',
    category: 'energy',
    tags: ['grid','renewables','edf'],
    image: 'https://images.unsplash.com/photo-1509395176047-4a66953fd231?q=80&w=800&auto=format&fit=crop',
    short: 'Microgrids, storage and grid-management platforms.',
    long: 'Distributed energy resources, large-scale PV integration, and demand-response systems led by utilities and startups across France.'
  },
  {
    id: 'withings-01',
    title: 'Connected Health Devices (Withings)',
    category: 'consumer',
    tags: ['health','wearables','iot'],
    image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?q=80&w=800&auto=format&fit=crop',
    short: 'Consumer health sensors and connected wellness devices.',
    long: 'Connected scales, sleep sensors, and health dashboards designed in France for longitudinal wellbeing and clinical integration.'
  },
  {
    id: 'criteo-01',
    title: 'Personalization AI (Criteo)',
    category: 'ai',
    tags: ['adtech','ml','personalization'],
    image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=800&auto=format&fit=crop',
    short: 'Real-time personalization and recommendation systems.',
    long: 'Large-scale recommender systems and privacy-aware personalization powering e-commerce and publisher monetization.'
  },
];
